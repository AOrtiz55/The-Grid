...
import { IPoduct } from './product.model';
...
@Component({
  ...
  imports: [CommonModule, ProductDetails, RouterLinkActive, RouterLink],
  standalone: true,
...
export class Catalog implements OnInit {
  ...
  constructor(
    ...
    this.products = [
      ...
      {
        id: 16,
        description: 'accelerometer capable of higher speeds and navigating rougher terrain ',
